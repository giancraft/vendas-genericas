...
public class CarrinhoDAO extends DAO {
	...
	public boolean insertProdutosInCarrinho(CarrinhoDTO carrinho) {
		List<Integer> produtos = carrinho.getProdutos();
		boolean returntype = false;
		for (int i = 0; i < produtos.size(); i++) {
		    int produto = produtos.get(i);
		    returntype = insertProdutoInCarrinho(produto, carrinho.getQuantidades().get(i), carrinho.getId());
		}
		return returntype;
	}
